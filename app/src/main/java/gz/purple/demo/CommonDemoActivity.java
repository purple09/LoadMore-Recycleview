...
import gz.purple.loadmore.commonadapter.RvLoadMoreCommonAdapter;
...
public class CommonDemoActivity extends AppCompatActivity {
    ...
    RvLoadMoreCommonAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        }.setLoadMoreMode(RVLoadMoreRvOnScrollListener.LOAD_MORE_IDLE));
    ...
    private RvLoadMoreCommonAdapter getAdapter(List<String> dataList) {
        return new RvLoadMoreCommonAdapter(dataList) {
            @NonNull
            @Override
